...
export default function Home({
  ...
  return (
    <div className={`min-h-screen ${myFont.className}`}>
      ...
      />
      <FullContainer>
        <Container className="overflow-hidden bg-green-300">
          <Carousel
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 absolute bottom-0 -ml-2 mb-3 w-full">
              <CarouselPrevious />
              <CarouselNext />
            </div>
          </Carousel>
